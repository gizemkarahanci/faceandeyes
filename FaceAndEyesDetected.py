...
#opencv, görüntü işleme kütüphanesi, c tabanlı bir kütüphane
import cv2

#haarcascade xml dosya yollarını belirtiyoruz
#haarcascade görüntü üzerinden nesneyi bulmak için kullanılır.
...
while True:
    #kameradan gelen görüntü karelerini frame de tutuyoruz, çerçeve
...
#Donanım kaynağını serbest bırakıp pencereyi kapatır
